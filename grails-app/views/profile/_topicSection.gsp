            ...
            <g:form method="get" url="[controller:'Topic',action:'createUserTopic']">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <p>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <select name="seriousness"><option value="Serious">Serious</option><option value="VerySerious">VerySerious</option> </select><img alt="mail" height="23" src="/linksharing/home/message.jpeg" title="mail" width="23" />
